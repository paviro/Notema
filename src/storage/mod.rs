...
pub use entry::{
    ...
    delete_journal, edit_encrypted_entry, entry_path, entry_template, is_encrypted_entry_file,
    is_entry_file, is_plain_entry_file, move_entry_to_trash, open_editor, open_editor_body_only,
    read_entries, read_entry, read_entry_content_with_identity, read_entry_with_identity,
    scan_entries, scan_entries_with_identity, set_updated_at_now,
};
