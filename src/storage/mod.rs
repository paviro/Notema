...
pub use entry::{
    Entry, EntryEncryptionState, EntryMetadata, EntryPath, collect_entry_paths,
    ...
    create_entry_with_editor_and_metadata, delete_journal, edit_encrypted_entry, entry_path,
