...
pub(crate) use entry::{
    ...
    is_encrypted_entry_file, is_plain_entry_file, move_entry_to_trash, read_entries,
    read_entry_content_with_identity, read_entry_with_identity, scan_entries_with_identity,
