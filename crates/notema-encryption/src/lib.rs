...
pub use identity::{
    ...
    forget_keyring_item, read_identity_file_bytes, restore_identity, restore_identity_file,
    set_identity_passphrase, set_key_location, snapshot_identity, unlock_fetched, unlock_identity,
};
